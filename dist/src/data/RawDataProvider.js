"use strict";
const StudentCourseConnection_1 = require("../model/StudentCourseConnection");
...
RawDataProvider.studentCourseConnections = [
    StudentCourseConnection_1.StudentCourseConnection.create("sc1", "c2", "s1"),
    StudentCourseConnection_1.StudentCourseConnection.create("sc2", "c2", "s3"),
    StudentCourseConnection_1.StudentCourseConnection.create("sc3", "c2", "s4"),
    StudentCourseConnection_1.StudentCourseConnection.create("sc4", "c2", "s5")
];
